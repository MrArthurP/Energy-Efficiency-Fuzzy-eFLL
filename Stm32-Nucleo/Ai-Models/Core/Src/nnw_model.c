...
#define AI_NET_OBJ_INSTANCE g_nnw_model
 
#undef AI_NNW_MODEL_MODEL_SIGNATURE
#define AI_NNW_MODEL_MODEL_SIGNATURE     "0xf4e97bfee61ed7c2ddbd03cad40739cb"
...
#define AI_TOOLS_DATE_TIME   "2026-09-04T15:17:15-0300"

#undef AI_TOOLS_COMPILE_TIME
#define AI_TOOLS_COMPILE_TIME    __DATE__ " " __TIME__

#undef AI_NNW_MODEL_N_BATCHES
#define AI_NNW_MODEL_N_BATCHES         (1)

static ai_ptr g_nnw_model_activations_map[1] = AI_C_ARRAY_INIT;
static ai_ptr g_nnw_model_weights_map[1] = AI_C_ARRAY_INIT;
...
AI_TENSOR_OBJ_DECLARE(
  ...
  14, 0x0,
  AI_SHAPE_INIT(4, 2, 24, 1, 1), AI_STRIDE_INIT(4, 4, 8, 192, 192),
...
AI_NETWORK_OBJ_DECLARE(
  ...
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
    AI_BUFFER_SHAPE_INIT(AI_SHAPE_BCWH, 4, 1, 2804, 1, 1),
    2804, NULL, NULL),
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
    AI_BUFFER_SHAPE_INIT(AI_SHAPE_BCWH, 4, 1, 192, 1, 1),
    192, NULL, NULL),
  AI_TENSOR_LIST_IO_OBJ_INIT(AI_FLAG_NONE, AI_NNW_MODEL_IN_NUM, &float_input_output),
  AI_TENSOR_LIST_IO_OBJ_INIT(AI_FLAG_NONE, AI_NNW_MODEL_OUT_NUM, &label_output, &output_probability_output),
  &mul_result_layer, 0x7a84c56d, NULL)
...
/******************************************************************************/
AI_DECLARE_STATIC
ai_bool nnw_model_configure_activations(
  ai_network* net_ctx, const ai_network_params* params)
{
  AI_ASSERT(net_ctx)

  if (ai_platform_get_activations_map(g_nnw_model_activations_map, 1, params)) {
    /* Updating activations (byte) offsets */
    
    float_input_output_array.data = AI_PTR(g_nnw_model_activations_map[0] + 88);
    float_input_output_array.data_start = AI_PTR(g_nnw_model_activations_map[0] + 88);
    mul_result_output_array.data = AI_PTR(g_nnw_model_activations_map[0] + 96);
    mul_result_output_array.data_start = AI_PTR(g_nnw_model_activations_map[0] + 96);
    next_activations_output_array.data = AI_PTR(g_nnw_model_activations_map[0] + 96);
    next_activations_output_array.data_start = AI_PTR(g_nnw_model_activations_map[0] + 96);
    mul_result1_output_array.data = AI_PTR(g_nnw_model_activations_map[0] + 0);
    mul_result1_output_array.data_start = AI_PTR(g_nnw_model_activations_map[0] + 0);
    next_activations1_output_array.data = AI_PTR(g_nnw_model_activations_map[0] + 96);
    next_activations1_output_array.data_start = AI_PTR(g_nnw_model_activations_map[0] + 96);
    mul_result2_output_array.data = AI_PTR(g_nnw_model_activations_map[0] + 0);
    mul_result2_output_array.data_start = AI_PTR(g_nnw_model_activations_map[0] + 0);
    out_activations_result_output_array.data = AI_PTR(g_nnw_model_activations_map[0] + 4);
    out_activations_result_output_array.data_start = AI_PTR(g_nnw_model_activations_map[0] + 4);
    negative_class_proba_output_array.data = AI_PTR(g_nnw_model_activations_map[0] + 0);
    negative_class_proba_output_array.data_start = AI_PTR(g_nnw_model_activations_map[0] + 0);
    probabilities_output_array.data = AI_PTR(g_nnw_model_activations_map[0] + 8);
    probabilities_output_array.data_start = AI_PTR(g_nnw_model_activations_map[0] + 8);
    output_probability_output_array.data = AI_PTR(g_nnw_model_activations_map[0] + 16);
    output_probability_output_array.data_start = AI_PTR(g_nnw_model_activations_map[0] + 16);
    argmax_output_output_array.data = AI_PTR(g_nnw_model_activations_map[0] + 0);
    argmax_output_output_array.data_start = AI_PTR(g_nnw_model_activations_map[0] + 0);
    classes_0_cast_output_array.data = AI_PTR(g_nnw_model_activations_map[0] + 4);
    classes_0_cast_output_array.data_start = AI_PTR(g_nnw_model_activations_map[0] + 4);
    array_feature_extractor_result_output_array.data = AI_PTR(g_nnw_model_activations_map[0] + 12);
    array_feature_extractor_result_output_array.data_start = AI_PTR(g_nnw_model_activations_map[0] + 12);
    label_output_array.data = AI_PTR(g_nnw_model_activations_map[0] + 0);
    label_output_array.data_start = AI_PTR(g_nnw_model_activations_map[0] + 0);
    return true;
  }
...
/******************************************************************************/
AI_DECLARE_STATIC
ai_bool nnw_model_configure_weights(
  ai_network* net_ctx, const ai_network_params* params)
{
  AI_ASSERT(net_ctx)

  if (ai_platform_get_weights_map(g_nnw_model_weights_map, 1, params)) {
    /* Updating weights (byte) offsets */
    
    unity_2D_array.format |= AI_FMT_FLAG_CONST;
    unity_2D_array.data = AI_PTR(g_nnw_model_weights_map[0] + 0);
    unity_2D_array.data_start = AI_PTR(g_nnw_model_weights_map[0] + 0);
    mul_result_weights_array.format |= AI_FMT_FLAG_CONST;
    mul_result_weights_array.data = AI_PTR(g_nnw_model_weights_map[0] + 4);
    mul_result_weights_array.data_start = AI_PTR(g_nnw_model_weights_map[0] + 4);
    mul_result_bias_array.format |= AI_FMT_FLAG_CONST;
    mul_result_bias_array.data = AI_PTR(g_nnw_model_weights_map[0] + 196);
    mul_result_bias_array.data_start = AI_PTR(g_nnw_model_weights_map[0] + 196);
    mul_result1_weights_array.format |= AI_FMT_FLAG_CONST;
    mul_result1_weights_array.data = AI_PTR(g_nnw_model_weights_map[0] + 292);
    mul_result1_weights_array.data_start = AI_PTR(g_nnw_model_weights_map[0] + 292);
    mul_result1_bias_array.format |= AI_FMT_FLAG_CONST;
    mul_result1_bias_array.data = AI_PTR(g_nnw_model_weights_map[0] + 2596);
    mul_result1_bias_array.data_start = AI_PTR(g_nnw_model_weights_map[0] + 2596);
    mul_result2_weights_array.format |= AI_FMT_FLAG_CONST;
    mul_result2_weights_array.data = AI_PTR(g_nnw_model_weights_map[0] + 2692);
    mul_result2_weights_array.data_start = AI_PTR(g_nnw_model_weights_map[0] + 2692);
    mul_result2_bias_array.format |= AI_FMT_FLAG_CONST;
    mul_result2_bias_array.data = AI_PTR(g_nnw_model_weights_map[0] + 2788);
    mul_result2_bias_array.data_start = AI_PTR(g_nnw_model_weights_map[0] + 2788);
    output_probability_classlabels_ints_array.format |= AI_FMT_FLAG_CONST;
    output_probability_classlabels_ints_array.data = AI_PTR(g_nnw_model_weights_map[0] + 2792);
    output_probability_classlabels_ints_array.data_start = AI_PTR(g_nnw_model_weights_map[0] + 2792);
    classes_array.format |= AI_FMT_FLAG_CONST;
    classes_array.data = AI_PTR(g_nnw_model_weights_map[0] + 2796);
    classes_array.data_start = AI_PTR(g_nnw_model_weights_map[0] + 2796);
    return true;
  }
  ...
  ai_handle network, ai_network_report* report)
{
  ...
  {
    ai_network_report r = {
      .model_name        = AI_NNW_MODEL_MODEL_NAME,
      .model_signature   = AI_NNW_MODEL_MODEL_SIGNATURE,
...
AI_API_ENTRY
ai_bool ai_nnw_model_get_report(
  ai_handle network, ai_network_report* report)
{
  ai_network* net_ctx = AI_NETWORK_ACQUIRE_CTX(network);
...
AI_API_ENTRY
ai_error ai_nnw_model_get_error(ai_handle network)
{
...
AI_API_ENTRY
ai_error ai_nnw_model_create_and_init(
  ai_handle* network, const ai_handle activations[], const ai_handle weights[])
{
  ai_error err;
  ai_network_params params;

  err = ai_nnw_model_create(network, AI_NNW_MODEL_DATA_CONFIG);
  if (err.type != AI_ERROR_NONE) {
    return err;
  }
  
  if (ai_nnw_model_data_params_get(&params) != true) {
    err = ai_nnw_model_get_error(*network);
    return err;
  }
#if defined(AI_NNW_MODEL_DATA_ACTIVATIONS_COUNT)
  /* set the addresses of the activations buffers */
  for (ai_u16 idx=0; activations && idx<params.map_activations.size; idx++) {
    AI_BUFFER_ARRAY_ITEM_SET_ADDRESS(&params.map_activations, idx, activations[idx]);
  }
#endif
#if defined(AI_NNW_MODEL_DATA_WEIGHTS_COUNT)
  /* set the addresses of the weight buffers */
  for (ai_u16 idx=0; weights && idx<params.map_weights.size; idx++) {
    AI_BUFFER_ARRAY_ITEM_SET_ADDRESS(&params.map_weights, idx, weights[idx]);
  }
#endif
  if (ai_nnw_model_init(*network, &params) != true) {
    err = ai_nnw_model_get_error(*network);
  }
  return err;
}
...
AI_API_ENTRY
ai_buffer* ai_nnw_model_inputs_get(ai_handle network, ai_u16 *n_buffer)
{
...
AI_API_ENTRY
ai_buffer* ai_nnw_model_outputs_get(ai_handle network, ai_u16 *n_buffer)
{
  if (network == AI_HANDLE_NULL) {
    network = (ai_handle)&AI_NET_OBJ_INSTANCE;
    AI_NETWORK_OBJ(network)->magic = AI_MAGIC_CONTEXT_TOKEN;
...
AI_API_ENTRY
ai_handle ai_nnw_model_destroy(ai_handle network)
{
  ...
  ai_handle network, const ai_network_params* params)
{
  ...
  ok &= nnw_model_configure_weights(net_ctx, params);
  ok &= nnw_model_configure_activations(net_ctx, params);
...
AI_API_ENTRY
ai_i32 ai_nnw_model_forward(ai_handle network, const ai_buffer* input)
{
