/**
  ...
  ******************************************************************************
  */
#ifndef AI_NBA_MODEL_H
#define AI_NBA_MODEL_H

#include "nba_model_config.h"
#include "ai_platform.h"

/******************************************************************************/
#define AI_NBA_MODEL_MODEL_NAME          "nba_model"
#define AI_NBA_MODEL_ORIGIN_MODEL_NAME   "nba_model"

/******************************************************************************/
#define AI_NBA_MODEL_ACTIVATIONS_ALIGNMENT   (4)
#define AI_NBA_MODEL_INPUTS_IN_ACTIVATIONS   (4)
#define AI_NBA_MODEL_OUTPUTS_IN_ACTIVATIONS  (4)

/******************************************************************************/
#define AI_NBA_MODEL_IN_NUM        (1)

AI_DEPRECATED
#define AI_NBA_MODEL_IN \
  ai_nba_model_inputs_get(AI_HANDLE_NULL, NULL)

#define AI_NBA_MODEL_IN_SIZE { \
  AI_NBA_MODEL_IN_1_SIZE, \
}
#define AI_NBA_MODEL_IN_SIZE_BYTES { \
  AI_NBA_MODEL_IN_1_SIZE_BYTES, \
}
#define AI_NBA_MODEL_IN_1_FORMAT      (AI_BUFFER_FORMAT_FLOAT)
#define AI_NBA_MODEL_IN_1_CHANNEL     (2)
#define AI_NBA_MODEL_IN_1_SIZE        (2)
#define AI_NBA_MODEL_IN_1_SIZE_BYTES  (8)

/******************************************************************************/
#define AI_NBA_MODEL_OUT_NUM       (2)

AI_DEPRECATED
#define AI_NBA_MODEL_OUT \
  ai_nba_model_outputs_get(AI_HANDLE_NULL, NULL)

#define AI_NBA_MODEL_OUT_SIZE { \
  AI_NBA_MODEL_OUT_1_SIZE, \
  AI_NBA_MODEL_OUT_2_SIZE, \
}
#define AI_NBA_MODEL_OUT_SIZE_BYTES { \
  AI_NBA_MODEL_OUT_1_SIZE_BYTES, \
  AI_NBA_MODEL_OUT_2_SIZE_BYTES, \
}
#define AI_NBA_MODEL_OUT_1_FORMAT      (AI_BUFFER_FORMAT_S32)
#define AI_NBA_MODEL_OUT_1_SIZE        (1)
#define AI_NBA_MODEL_OUT_1_SIZE_BYTES  (4)
#define AI_NBA_MODEL_OUT_2_FORMAT      (AI_BUFFER_FORMAT_FLOAT)
#define AI_NBA_MODEL_OUT_2_HEIGHT      (1)
#define AI_NBA_MODEL_OUT_2_WIDTH       (2)
#define AI_NBA_MODEL_OUT_2_CHANNEL     (2)
#define AI_NBA_MODEL_OUT_2_SIZE        (4)
#define AI_NBA_MODEL_OUT_2_SIZE_BYTES  (16)

/******************************************************************************/
#define AI_NBA_MODEL_N_NODES (18)
 ...
 * @ref ai_nba_model_create. Both the activations memory buffer 
 ...
 * using @ref ai_nba_model_get_error
 */
AI_API_ENTRY
 ...
 */
AI_API_ENTRY
ai_buffer* ai_nba_model_inputs_get(
 ...
 */
AI_API_ENTRY
ai_buffer* ai_nba_model_outputs_get(
  ai_handle network, ai_u16 *n_buffer);
 ...
 * header generated by the code generation tool. See AI_NBA_MODEL_*
 * defines into file @ref nba_model.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
 ...
 */
AI_API_ENTRY
ai_i32 ai_nba_model_forward(
  ai_handle network, const ai_buffer* input);

AI_API_DECLARE_END

#endif /* AI_NBA_MODEL_H */
