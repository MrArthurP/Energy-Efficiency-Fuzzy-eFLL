...
// Nesse caso temos um total de 20 regras fuzzy: 4 regras para cada um dos 5 conjuntos fuzzy de entrada (Breserva, Bextremamente_baixa, Bbaixa, Bmedia, Balta) combinados com os 4 conjuntos fuzzy de taxa (Qmuitobaixa, Qbaixa, Qalta, Qmuitoalta). Cada regra é representada por uma combinação específica dos conjuntos fuzzy de entrada e uma decisão de saída (Liga ou NaoLiga).
...
void setup() { 
  ...
  Taxa->addFuzzySet(Qmuitobaixa);
  Taxa->addFuzzySet(Qbaixa);
  Taxa->addFuzzySet(Qalta);
  Taxa->addFuzzySet(Qmuitoalta);
...
regras1_2->joinWithAND(Breserva, Qalta);
...
regras1_3->joinWithAND(Breserva, Qbaixa);
...
regras1_4->joinWithAND(Breserva, Qmuitobaixa);
...
regras2_1->joinWithAND(Bextremamente_baixa, Qmuitoalta);
...
regras2_2->joinWithAND(Bextremamente_baixa, Qalta);
...
regras2_3->joinWithAND(Bextremamente_baixa, Qbaixa);
...
regras2_4->joinWithAND(Bextremamente_baixa, Qmuitobaixa);
...
regras3_1->joinWithAND(Bbaixa, Qmuitoalta);
...
regras3_2->joinWithAND(Bbaixa, Qalta);
...
regras3_3->joinWithAND(Bbaixa, Qbaixa);
...
regras3_4->joinWithAND(Bbaixa, Qmuitobaixa);
...
regras4_1->joinWithAND(Bmedia, Qmuitoalta);
...
regras4_2->joinWithAND(Bmedia, Qalta);
...
regras4_3->joinWithAND(Bmedia, Qbaixa);
...
regras4_4->joinWithAND(Bmedia, Qmuitobaixa);
...
regras5_1_antecedente->joinWithAND(Balta, Qmuitoalta);
...
regras5_2_antecedente->joinWithAND(Balta, Qalta);
...
regras5_3_antecedente->joinWithAND(Balta, Qbaixa);
...
regras5_4_antecedente->joinWithAND(Balta, Qmuitobaixa);
